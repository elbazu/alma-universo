        ...
        <div className="flex gap-6">
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h1 className="font-display text-2xl font-semibold text-gray-900 mb-1">Miembros</h1>
                <p className="text-sm text-gray-500">{communityData.stats.members} miembros · {communityData.stats.online} en línea</p>
              </div>
              {/* Search */}
