...
import { Search, Bell, MessageCircle, ChevronDown, LogOut, Settings } from 'lucide-react'
        ...
        <div className="flex items-center h-14 gap-3">
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 top-full mt-1 w-48 bg-surface text-body rounded-xl shadow-lg border border-border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-150 z-50">
                {user?.email && (
                ...
                <button
                  onClick={signOut}
                  className="w-full flex items-center gap-2 px-3 py-2.5 text-sm text-body-secondary hover:text-brand-600 hover:bg-brand-50 dark:hover:bg-brand-950 rounded-b-xl transition-colors"
                >
                  <LogOut size={14} />
                  Cerrar sesión
                </button>
